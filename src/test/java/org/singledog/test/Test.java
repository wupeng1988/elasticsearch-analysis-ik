...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        String text = read("C:\\Users\\lenovo\\Desktop\\a.txt");
        String text2 = read("C:\\Users\\lenovo\\Desktop\\b.txt");
        ...
        Simhash simhash = new Simhash(new BinaryWordSeg(configuration), true);
